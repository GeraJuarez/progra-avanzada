...
unsigned
doHash(unsigned int str, int size)
{
    unsigned hash = 5381;
...
static void hashDoInsert(HashInt* h, int k, int v) {
...
void hashInsert(HashInt* h, int k, int v) 
{
